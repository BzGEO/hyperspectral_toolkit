/* DATA VISUALIZATION: DISPLAY PACE OCI MONTHLY SURFACE REFLECTANCE DATA FOR THE GLOBE
...
var roi = ee.Geometry.Polygon([[[-125.2, 49.5], [-125.2, 24.5],[-66.0, 24.5],  [-66.0, 49.5]]], null, false);
...
Map.addLayer(c.pace_oci_mt_global_202505, b.viz3, "PACE OCI SR - May 2025*", 1);

Map.addLayer(a.ln(roi, 2), {palette: "red"}, "US AOI", 0);
